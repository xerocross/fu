...
describe('test array suite', function () {
    describe("test isArraysEqual", function () {
        test("empty arrays", function () {
            expect(functional_utility_1["default"].array.isArraysEqual([], [], function (x, y) { return x == y; })).toBeTruthy();
        });
        test("isArraysEqual positive", function () {
            var arr1 = [0, 1, 2, 3, 4, 5, 6, 7];
            var arr2 = [0, 1, 2, 3, 4, 5, 6, 7];
            expect(functional_utility_1["default"].array.isArraysEqual(arr1, arr2, function (x, y) { return x == y; })).toBeTruthy();
        });
        test("isArraysEqual negative", function () {
            var arr1 = [0, 1, 2, 3, 4, 5, 6, 7];
            var arr2 = [0, 1, 5, 3, 4, 5, 6, 7];
            expect(functional_utility_1["default"].array.isArraysEqual(arr1, arr2, function (x, y) { return x == y; })).toBeFalsy();
        });
        test("throws on invalid left array", function () {
            expect(function () {
                // @ts-ignore
                functional_utility_1["default"].array.isArraysEqual("", [], function (x, y) { return x == y; });
            }).toThrow();
        });
        test("throws on invalid right array", function () {
            expect(function () {
                // @ts-ignore
                functional_utility_1["default"].array.isArraysEqual([], "a", function (x, y) { return x == y; });
            }).toThrow();
        });
    ...
    describe("join right suite", function () {
        test("join right nonempty array", function () {
            ...
            expect(functional_utility_1["default"].array.isArraysEqual(newArr, [0, 1, 2, 3, 4, 5, 6, 7, 8], function (x, y) { return x == y; })).toBe(true);
        });
        test("join right empty array", function () {
            var newArr = functional_utility_1["default"].array.joinRight([], 8);
            expect(functional_utility_1["default"].array.isArraysEqual(newArr, [8], function (x, y) { return x == y; })).toBe(true);
        });
    ...
    describe("join left suite", function () {
        test("nonempty array", function () {
            ...
            expect(functional_utility_1["default"].array.isArraysEqual(newArr, [8, 0, 1, 2, 3, 4, 5, 6, 7], function (x, y) { return x == y; })).toBe(true);
        });
    ...
    describe("test bubbleUp suite", function () {
        test("on valid inputs", function () {
            ...
            var res = functional_utility_1["default"].array.bubbleUp(arr, arr.length - 1, function (x, y) { return x - y; });
            expect(functional_utility_1["default"].array.isArraysEqual(res, [0, 1, 2, 3, 4, 5, 6, 7, 72], function (x, y) { return x == y; })).toBe(true);
        });
        test("throws on index < 0", function () {
            var arr = [0, 1, 2, 72, 3, 4, 5, 6, 7];
            expect(function () {
                functional_utility_1["default"].array.bubbleUp(arr, -1, function (x, y) { return x - y; });
            }).toThrow();
        });
        test("throws on index >= arr.length", function () {
            var arr = [0, 1, 2, 72, 3, 4, 5, 6, 7];
            expect(function () {
                functional_utility_1["default"].array.bubbleUp(arr, arr.length, function (x, y) { return x - y; });
            }).toThrow();
        });
        test("throws on invalid arr type", function () {
            expect(function () {
                // @ts-ignore
                functional_utility_1["default"].array.bubbleUp("", 5, function (x, y) { return x - y; });
            }).toThrow();
        });
    });
    test("bubbleSort", function () {
        var arr = [3, 6, 98, 2, 6, 77, 3, 2, 5];
        var res = functional_utility_1["default"].array.bubbleSort(arr, function (x, y) { return x - y; });
    ...
    describe("isSorted suite", function () {
        test("isSorted positive", function () {
            ...
            expect(functional_utility_1["default"].array.isSorted(arr, arr.length, function (x, y) { return x - y; })).toBe(true);
        });
        test("isSorted negative", function () {
            var arr = [0, 5, 8, 11, 10, 77];
            expect(functional_utility_1["default"].array.isSorted(arr, arr.length, function (x, y) { return x - y; })).toBe(false);
        });
    });
    describe("subarrayMax", function () {
        test("valid input", function () {
            ...
            expect(functional_utility_1["default"].array.isArraysEqual(functional_utility_1["default"].array.subarrayMax(arr, 4), expectedSubarray, function (x, y) { return x == y; })).toBeTruthy();
        });
        test("max is exactly arr.length", function () {
            var arr = [0, 1, 2, 72, 3, 4, 5, 6, 7];
            expect(functional_utility_1["default"].array.isArraysEqual(functional_utility_1["default"].array.subarrayMax(arr, arr.length), arr, function (x, y) { return x == y; })).toBeTruthy();
        });
    ...
    describe("subarrayMin", function () {
        test("valid input", function () {
            ...
            expect(functional_utility_1["default"].array.isArraysEqual(functional_utility_1["default"].array.subarrayMin(arr, 5), expectedSubarray, function (x, y) { return x == y; })).toBeTruthy();
        });
        test("invalid arr throws", function () {
            var arr = "[0,1,2,72,3,4,5,6,7]";
            expect(function () {
    ...
    describe("clone", function () {
        test("valid inupt", function () {
            ...
            expect(functional_utility_1["default"].array.isArraysEqual(arr, res, function (x, y) { return x == y; })).toBe(true);
        });
        test("invalid array throws", function () {
            expect(function () {
                // @ts-ignore
    ...
    describe('getPrimeFactors', function () {
        ...
        var _loop_2 = function (i) {
            test("valid " + battery[i].num, function () {
                ...
                expect(functional_utility_1["default"].array.isArraysEqual(res, expected, function (x, y) { return x == y; })).toBe(true);
            });
        };
        for (var i = 0; i < battery.length; i++) {
            _loop_2(i);
